...
const config = {
    serverInfo: {
        ...
        serverName: "AXVORA", /*Server name*/
        serverIp: "play.axvora.my.id:19132", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "953333537728237609" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    contactPage: {
        email: "axvora.official@gmail.com"
    }
}
